...
/* IMPORTANT NOTE:
  The line in NativeEventEmitter.js:
  invariant(nativeModule, 'Native module cannot be null.');
  has been commented out but should be properly handled before production.
*/
...
class Automate extends React.Component {
    ...
    render() {
        let { supported, enabled, tag, isWritinc, urlToWrite, parsedText, rtdType } = this.state;
        return (
            <ScrollView style={{flex: 1, backgroundColor: '#fbb464'}}>
